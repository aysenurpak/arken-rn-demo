import { Button, FlatList, Modal, Pressable, StatusBar, Text, TextInput, TouchableOpacity, View } from 'react-native';
import {
  SafeAreaProvider,
  SafeAreaView,
} from 'react-native-safe-area-context';
import styles from "../styles/screens/ToDoScreenStyles";
  ...
  return (
    <SafeAreaProvider>
      ...
      <SafeAreaView style={styles.container} >
        ...
        <Button title='A Screen' onPress={() => {
          navigation.navigate('A');
        }} />

        <Button title='B Screen' onPress={() => {
